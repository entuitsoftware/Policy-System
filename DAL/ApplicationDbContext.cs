...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Policy>().ToTable(nameof(Policies));
            builder.Entity<Invoice>().ToTable(nameof(Invoices));
            builder.Entity<Lead>().ToTable(nameof(Leads));
            builder.Entity<BankingDetail>().ToTable(nameof(BankingDetails));
