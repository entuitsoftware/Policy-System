...
namespace OnlineStore.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        [HttpGet("users/me", Name = nameof(GetCurrentUser))]
        ...
        [HttpGet("users/username/{userName}", Name = nameof(GetUserByUserName))]
        [ProducesResponseType(200, Type = typeof(UserViewModel))]
        [ProducesResponseType(403)]
        [ProducesResponseType(404)]
        ...
        {
            return await GetUsersPaginated(-1, -1);
        }


        [HttpGet("users/{pageNumber:int}/{pageSize:int}", Name = nameof(GetUsersPaginated))]
        [Authorize(Authorization.Policies.ViewAllUsersPolicy)]
        [ProducesResponseType(200, Type = typeof(List<UserViewModel>))]
        public async Task<IActionResult> GetUsersPaginated(int pageNumber, int pageSize)
        {
        ...
        [HttpPut("users/me", Name = nameof(UpdateCurrentUser))]
        ...
        [HttpPut("users/{id}", Name = nameof(UpdateUser))]
        [ProducesResponseType(204)]
        [ProducesResponseType(400)]
        [ProducesResponseType(403)]
        [ProducesResponseType(404)]
        ...
        [HttpPatch("users/me", Name = nameof(PartialUpdateCurrentUser))]
        [ProducesResponseType(204)]
        [ProducesResponseType(400)]
        public async Task<IActionResult> PartialUpdateCurrentUser([FromBody] JsonPatchDocument<UserPatchViewModel> patch)
        {
            return await PartialUpdateUser(Utilities.GetUserId(this.User), patch);
        }


        [HttpPatch("users/{id}", Name = nameof(PartialUpdateUser))]
        [ProducesResponseType(204)]
        [ProducesResponseType(400)]
        [ProducesResponseType(403)]
        [ProducesResponseType(404)]
        public async Task<IActionResult> PartialUpdateUser(string id, [FromBody] JsonPatchDocument<UserPatchViewModel> patch)
        {
        ...
        [HttpPost("users", Name = nameof(Register))]
        ...
        [HttpDelete("users/{id}", Name = nameof(DeleteUser))]
        [ProducesResponseType(200, Type = typeof(UserViewModel))]
        [ProducesResponseType(400)]
        [ProducesResponseType(403)]
        [ProducesResponseType(404)]
        ...
        [HttpGet("roles/name/{name}", Name = nameof(GetRoleByName))]
        [ProducesResponseType(200, Type = typeof(RoleViewModel))]
        [ProducesResponseType(403)]
        [ProducesResponseType(404)]
        ...
        {
            return await GetPaginatedRoles(-1, -1);
        }


        [HttpGet("roles/{pageNumber:int}/{pageSize:int}", Name = nameof(GetPaginatedRoles))]
        [Authorize(Authorization.Policies.ViewAllRolesPolicy)]
        [ProducesResponseType(200, Type = typeof(List<RoleViewModel>))]
        public async Task<IActionResult> GetPaginatedRoles(int pageNumber, int pageSize)
        {
